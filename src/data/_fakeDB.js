...
export const database = {
  subscribedPodcasts: [
    ...
    new PodcastChannel(
      'Braincast',
      'http://www.b9.com.br/',
      new PodcastAuthor('B9', 'podcasts@g.globo'),
    ...
    new PodcastChannel(
      '99% Invisible',
      'https://www.99pi.org',
      new PodcastAuthor('Roman Mars', 'contact@99pi.org'),
    ...
    new PodcastChannel(
      ...
      new PodcastAuthor('Alura', 'paulo.silveira@alura.com.br'),
    ...
    new PodcastChannel(
      ...
      new PodcastAuthor('HD1', 'feeds@halfdeaf.com.br'),
    ...
    new PodcastChannel(
      ...
      new PodcastAuthor('B9', 'podcast@naruhodo.com.br'),
    ...
    new PodcastChannel(
      ...
      new PodcastAuthor('Doctor Who Brasil', 'contato@doctorwhobrasil.com.br'),
    ...
    new PodcastChannel(
      ...
      new PodcastAuthor('ADeD Studio', 'adrianosbr@gmail.com'),
    ...
    new PodcastChannel(
      ...
      new PodcastAuthor('Marcos Beccari', ''),
    ...
    new PodcastChannel(
      ...
      new PodcastAuthor('QuebraDev', 'quebradev@gmail.com'),
    ...
    new PodcastChannel(
      ...
      new PodcastAuthor('O Alvissareiro', 'tecnico@oalvissareiro.com.br'),
